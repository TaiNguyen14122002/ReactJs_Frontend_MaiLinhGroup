...
const ProjectDetails = () => {
          ...
          () => {
            ...
            getDownloadURL(uploadTask.snapshot.ref)
              .then((downloadURL) => {
                ...
                const token = localStorage.getItem('jwt');
                // fetch(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/uploadFileToProject/${id}/upload`, {
                //   method: 'PUT',
                //   headers: {
  ...
  const handleDelete = async (FileInfoId) => {
    ...
    try {
      ...
      const response = await axios.delete(`https://springbootbackendpms2012202-production.up.railway.app/api/file-info/delete/${FileInfoId}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const fetchProcessData = async () => {
    ...
    try {
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/issues/projects/completion-ratio`, {
        headers: {
          Authorization: `Bearer ${token}`
        },
        params: { projectId: id }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/updateProject/${id}`, fetchproject.projectDetails, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const UpdateProjectPinned = async () => {
    try {
      ...
      const response = await axios.put(
        `https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}/update-action`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const ExportToExcel = async () => {
    ...
    if (inforUser.id === inforProject.owner?.id) {
      try {
        ...
        const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/projects/${id}/issues/export`, {
          headers: {
            "Authorization": `Bearer ${token}`
          },
  ...
  const fetchMember = async () => {
    if (!token) {
      ...
      console.log("id", id)
      try {
        const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/users/project/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
  ...
  const addWorkTypeMenbers = async (memberId, newWorkType) => {
    if (inforUser.id === inforProject.owner?.id) {
      try {
        ...
        const response = await axios.post(`https://springbootbackendpms2012202-production.up.railway.app/api/worktype/addWorkType`, null, {
          params: requestData,
          headers: {
            Authorization: `Bearer ${token}`
          }
  ...
  const updateWorkTypeMenbers = async (memberId, newWorkType) => {
    if (inforUser.id === inforProject.owner?.id) {
      try {
        ...
        console.log("Dữ liệu truyền vào", requestData)
        const response = await axios.put(`https://springbootbackendpms2012202-production.up.railway.app/api/worktype/update`, null, {
          params: requestData,
          headers: {
            Authorization: `Bearer ${token}`
          }
  ...
  const fetchTask = async () => {
    try {
      ...
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/issues/project/${id}`, {
  ...
  const onStatusChange = async (value) => {
    ...
    if (value === 'done' || value === "inprocess") {
      try {
        ...
        const response = await axios.put(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}/status`, null, {
          params: requestData,
          headers: {
            Authorization: `Bearer ${token}`
          }
  ...
  const fetchProjectTabs = async () => {
    try {
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/taskCategories/project/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const addProjectTabs = async (newTabId) => {
    try {
      ...
      const response = await axios.post(`https://springbootbackendpms2012202-production.up.railway.app/api/taskCategories/project/${id}`, {}, {
        params: requestData,
        headers: {
          Authorization: `Bearer ${token}`
        }
  ...
  const deleteProjectTabs = async (TabsId) => {
    try {
      const response = await axios.delete(`https://springbootbackendpms2012202-production.up.railway.app/api/taskCategories/project/${id}/task/${TabsId}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const PdfExport = async (userId) => {
    try {
      ...
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/export/projects/${id}/users/${userId}/tasks/pdf`, {
        headers: {
          Authorization: `Bearer ${token}`
        },
        responseType: 'blob',
  ...
  const fetchFileInfo = async () => {
    try {
      ...
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/file-info/project/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const handleExtend = async () => {
    if (newEndDate) {
      try {
        const response = await axios.put(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}/endDate`,
          newEndDate,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleDeleteMember = async (memberId) => {
    ...
    try {
      const response = await axios.delete(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}/members/${memberId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const fetchAvatarOwner = async() => {
    try{
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${id}/ownerFile`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
