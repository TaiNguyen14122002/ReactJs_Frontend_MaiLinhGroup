...
const ProjectDeleted = () => {
  ...
  const fetchProjectDeleted = async () => {
    ...
    try {
      const response = await axios.get(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/Projectsdeleted`, {
        headers: {
  ...
  const handleRestore = async (projectId) => {
    ...
    try {
      ...
      const response = await axios.put(`https://springbootbackendpms2012202-production.up.railway.app/api/projects/${projectId}/update-action-deleted?action=0`,
